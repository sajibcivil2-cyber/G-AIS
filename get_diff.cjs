...
const diffText = `--- src/utils/dseBacktestEngine.ts
+++ src/utils/dseBacktestEngine.ts
@@ -24,7 +24,8 @@ import {
   EarlyTrendAnalysis,
   PatternEdgeStat,
